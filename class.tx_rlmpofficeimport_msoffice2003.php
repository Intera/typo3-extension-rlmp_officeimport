 ...
 */
class tx_rlmpofficeimport_msoffice2003 extends tx_rlmpofficeimport_xml {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/rlmp_officeimport/class.tx_rlmpofficeimport_msoffice2003.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/rlmp_officeimport/class.tx_rlmpofficeimport_msoffice2003.php']);
}
?>
